...
// { name: 'vehicle_insurance_pic', maxCount: 1 },
// { name: 'vehicle_fitness_pic', maxCount: 1 },
...
//       vehicle_insurance_pic: { data: req.files['vehicle_insurance_pic'][0].buffer, contentType: req.files['vehicle_insurance_pic'][0].mimetype },
//       vehicle_fitness_pic: { data: req.files['vehicle_fitness_pic'][0].buffer, contentType: req.files['vehicle_fitness_pic'][0].mimetype },
